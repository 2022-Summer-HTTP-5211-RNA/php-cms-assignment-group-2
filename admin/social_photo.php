...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="social_photo.php?id=<?php echo $_GET['id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Logo</a></p>
...
<p><a href="social_media.php"><i class="fas fa-arrow-circle-left"></i> Return to Social Media media</a></p>
